...
const ROLE_PERMISSIONS = Object.freeze({
  owner: ['*'],
  admin: ['project:read', 'project:create', 'project:delete', 'deploy:run', 'env:write', 'env:read', 'db:create', 'db:delete', 'db:connect', 'team:invite', 'audit:read', 'billing:read'],
  developer: ['project:read', 'project:create', 'deploy:run', 'logs:read', 'metrics:read', 'env:write-limited', 'db:connect-limited'],
  viewer: ['project:read', 'logs:read', 'metrics:read'],
  'billing-manager': ['project:read', 'billing:read', 'billing:write', 'usage:read'],
  'db-admin': ['project:read', 'db:create', 'db:delete', 'db:connect', 'db:query', 'backup:restore'],
  'project-owner': ['project:*'],
  maintainer: ['project:read', 'deploy:run', 'env:write', 'env:read', 'db:connect', 'logs:read', 'metrics:read'],
});
