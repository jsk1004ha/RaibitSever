...
@Module({
  controllers: [AuthController, ProjectsController, ServicesController, DeploymentsController, ServiceDeploymentsController, DeploymentLogsController, ResourcesController, ResourceConsoleController, EnvironmentController, GitHubIntegrationController, AdminController, UsageController],
